        ...
        <ul class="metismenu" id="menu">
            ...
            <li>
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="./app-change-password.php">Change Password</a></li>
                    <li><a href="./app-add-product.php">Add Product</a></li>
                    <li><a href="./app-all-products.php">All Products</a></li>
                    <li><a href="./app-update-products.php">Update Products</a></li>
